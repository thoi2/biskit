          ...
          <div className="w-full px-6">
            <div className="flex items-center justify-between py-4">
              ...
              <Link href="/" className="flex items-center gap-4 group">
                  ...
                  >
                    <div className="relative">
                      <div className="flex gap-2 mb-1.5">
                        <div className="w-2 h-2 rounded-full" style={{ backgroundColor: '#654321' }}></div>
                        <div className="w-2 h-2 rounded-full" style={{ backgroundColor: '#654321' }}></div>
                      </div>
                      <div className="w-4 h-2 rounded-b-full" style={{ backgroundColor: '#654321' }}></div>
                ...
                <div>
                  <h1 className="text-2xl font-bold text-white tracking-wide">BISKIT</h1>
                ...
                {user ? (
                    <>
                      <div className="text-right hidden md:block">
                        ...
                        <span className="text-lg font-semibold text-white">{user.name}님</span>
                      </div>
