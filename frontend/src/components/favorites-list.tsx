...
export function FavoritesList() {
  ...
  const fetchFavorites = async () => {
    try {
      ...
      const data: Favorite[] = []; const error = null; // Mock data for now
      ...
      <CardContent>
        {favorites.length === 0 ? (
          <div className="text-center py-8">
            ...
            <p className="text-sm text-muted-foreground mt-2">관심있는 상가에 하트를 눌러 저장해보세요</p>
          </div>
        ) : (
          <div className="space-y-3">
            {favorites.map((favorite) => {
              ...
              return (
                <div key={favorite.id} className="border rounded-lg p-4 hover:bg-muted/50 transition-colors">
                  <div className="flex items-start justify-between">
                    <div className="flex-1">
                      <div className="flex items-center gap-2 mb-2">
                        <h4 className="font-medium">{favorite.business_name}</h4>
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <Badge className={`${risk.color} text-white`}>{favorite.closure_probability}%</Badge>
                    ...
                    <div className="flex gap-2">
                      <Button
                        ...
                        onClick={() => {
                          ...
                          console.log("Navigate to:", favorite.latitude, favorite.longitude)
                        }}
                      >
