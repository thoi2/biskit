...
import { MapPin, Target, Circle, Building2, Map, BarChart3 } from "lucide-react"
...
export function RecommendationPanel({ onAnalysisRequest, setActiveTab }: RecommendationPanelProps) {
  ...
  const handleRangeAnalysis = async () => {
    ...
    try {
      await onAnalysisRequest("range", { coordinates, businessType, radius: rangeRadius, count: resultCount })
      setActiveTab("result")
    } finally {
      setIsAnalyzing(false)
    }
  ...
  const handleDistrictAnalysis = async () => {
    ...
    try {
      await onAnalysisRequest("district", { district: selectedDistrict, businessType, count: resultCount })
      setActiveTab("result")
    } finally {
      setIsAnalyzing(false)
    }
  ...
  const handleNeighborhoodAnalysis = async () => {
    ...
    try {
      await onAnalysisRequest("neighborhood", { neighborhood: selectedNeighborhood, businessType, count: resultCount })
      setActiveTab("result")
    } finally {
      setIsAnalyzing(false)
    }
                    ...
                    <CardContent className="space-y-3">
                      <div className="grid grid-cols-2 gap-2">
                        <div>
                          ...
                          <Select value={rangeRadius} onValueChange={setRangeRadius} disabled={isAnalyzing}>
                            <SelectTrigger className="text-sm">
                              <SelectValue />
                            </SelectTrigger>
                            <SelectContent>
                        ...
                        <div>
                          ...
                          <Select value={resultCount} onValueChange={setResultCount} disabled={isAnalyzing}>
                            <SelectTrigger className="text-sm">
                              <SelectValue />
                            </SelectTrigger>
                            <SelectContent>
                  ...
                  <Card>
                    ...
                    <CardContent className="space-y-3">
                      <div>
                        ...
                        <Select value={selectedDistrict} onValueChange={setSelectedDistrict} disabled={isAnalyzing}>
                          <SelectTrigger className="text-sm">
                  ...
                  <Card>
                    ...
                    <CardContent className="space-y-3">
                      <div>
                        ...
                        <Select value={selectedNeighborhood} onValueChange={setSelectedNeighborhood} disabled={isAnalyzing}>
                          <SelectTrigger className="text-sm">
